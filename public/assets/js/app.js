! function (s) {
    ...
    function a(e) {
        document.getElementById("header-lang-img") && ("id" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/id-flag.jpg" : "en" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/us.jpg" : "gr" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/germany.jpg" : "it" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/italy.jpg" : "ru" == e && (document.getElementById("header-lang-img").src = "/assets/images/flags/russia.jpg"), localStorage.setItem("language", e), null == (t = localStorage.getItem("language")) && a(n), s.getJSON("/assets/lang/" + t + ".json", function (e) {
