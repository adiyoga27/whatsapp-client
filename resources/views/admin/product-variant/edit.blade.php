                ...
                <div class="card-body">
                    ...
                    <div id="basic-example">
                        ...
                        <section>
                            ...
                            <form action="{{ route('product-variant.update', [$product_variant->id]) }}" method="POST">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="col-lg">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control @error('variant_id') is-invalid @enderror"
                                                ...
                                                @foreach ($variant as $val)
                                                    <option value="{{ $val->id }}"
                                                        {{ old('variant_id') == $val->id ? 'selected' : ($val->id == $product_variant->variant_id ? 'selected' : '') }}>
                                                        {{ $val->name }}</option>
                                                @endforeach
                                    ...
                                    <div class="col-lg">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                name="name"
                                                value="{{ old('name') ? old('name') : $product_variant->name }}"
                                                id="product-name" placeholder="Enter product variant name" required>
                                            @error('name')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('price') is-invalid @enderror"
                                                name="price"
                                                value="{{ old('price') ? old('price') : $product_variant->price }}"
                                    ...
                                    <div class="col-lg">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('weight') is-invalid @enderror"
                                                name="weight"
                                                value="{{ old('weight') ? old('weight') : $product_variant->weight }}"
