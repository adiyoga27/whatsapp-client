    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18" key="t-update-data">Add New Article Category</h4>

                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);" key="t-article-category-header">Article
                            Category</a></li>
                    <li class="breadcrumb-item active" key="t-update-data">Add New Article Category</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="basic-example">
                        <!-- Seller Details -->
                        <section>
                            <form action="{{ route('article-category.update', [$article->id]) }}" method="POST">
                                @method('put')
                                @csrf
                                <div class="row justify-content-center">
                                    <div class="col-lg-9">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="name"
                                                        value="{{ old('name') ? old('name') : $article->name }}"
