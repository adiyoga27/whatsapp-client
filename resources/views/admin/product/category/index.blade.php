    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18" key="t-product-category-sub-header">All Product Category</h4>

                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);" key="t-product-category-header">Product
                            Category</a></li>
                    <li class="breadcrumb-item active" key="t-product-category-sub-header">All Product Category</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="button-create mb-3 text-end">
                            <a href="{{ route('product-category.create') }}" class="btn btn-primary"><i
                                    class="bx bx-plus"></i> <span key="t-add">Add
                                    New</span></a>
                        </div>
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    @foreach ($product_category as $val)
                                        <tr>
                                            ...
                                            <td class="">
                                                <div class="d-flex">
                                                    <a href="{{ route('product-category.edit', [$val->id]) }}"
                                                    ...
                                                    <form action="" id="form-delete" method="post">
                                                        ...
                                                        <button class="btn btn-danger waves-effect waves-light"
                                                            data-softdeletedurl="{{ route('product-category.destroy', [$val->id]) }}"
