    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18" key="t-add-data">Add New Product</h4>

                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);" key="t-product-header">Product</a></li>
                    <li class="breadcrumb-item active" key="t-add-data">Add New Product</li>
                </ol>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control @error('category_id') is-invalid @enderror"
                                                        ...
                                                        @foreach ($product_category as $val)
                                                            <option value="{{ $val->id }}"
                                                                {{ old('category_id') == $val->id ? 'selected' : '' }}>
                                                                {{ $val->name }}</option>
                                                        @endforeach
