...
lg:flex-col-reverse lg:px-8 lg:gap-y-10">
    <div class="w-[291px] h-[407px]
    lg:mx-auto lg:w-[139.69px] lg:h-[195.72px]">
        <img class="w-full h-full object-contain" class="w-full h-full object-contain"
    ...
    <div class="self-center flex flex-col">
        ...
        lg:self-center lg:h-10 lg:text-[13px]">Order
                via WA</button>
        </a>
    </div>
</section>
