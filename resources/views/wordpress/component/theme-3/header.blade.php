                ...
                lg:flex-col lg:self-start lg:w-full lg:text-[17px] lg:uppercase lg:mb-3 lg:mt-6">
                        <a href="/"
                            class="my-4 px-3.5 relative  cursor-pointer after:content-[''] {{ Request::is('/')
                                ? 'after:absolute after:-bottom-2 after:left-0 after:bg-apple after:h-0.5 after:w-full
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          lg:after:absolute lg:after:left-0 lg:after:top-0 lg:after:h-full lg:after:w-1 lg:after:bg-apple lg:my-0 lg:py-4 lg:px-10 lg:after:rounded-r-[3px]'
                                : '' }}
            hover:after:content-[''] hover:after:absolute hover:after:-bottom-2 hover:after:left-0 hover:after:bg-apple hover:after:h-0.5 hover:after:w-full 
