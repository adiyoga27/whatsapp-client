<section
    class="text-arsenic w-full text-center pt-0 pb-20 font-poppins-regular custom-section-4 theme-11
lg:px-3 lg:pt-10">
    <div class="text-base font-inter-semibold  mb-6 relative text-apple
    lg:text-[13px] lg:mb-3 lg:text-left">
        Dibuat Untuk Anda</div>
    <div class="text-[40px] font-inter-bold capitalize mb-6
    lg:text-[24] lg:mb-4  lg:text-left">Produk Varash</div>
    <div class="font-inter-regular text-sm text-spanish-gray
    lg:text-[13px]  lg:text-left">Berikut daftar dari produk
        varash yang
        kami buat untuk
        Anda.</div>
