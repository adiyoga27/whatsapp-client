<header class="absolute top-0 h-26 flex   w-full font-inter-regular bg-white">
    ...
    lg:flex-row-reverse lg:px-10">
        <div class="self-center ">
            <a href="/" class="">
                ...
                lg:w-[60px] lg:h-[60px]" src="{{ asset('/wordpress/img/logo.png') }}" alt="logo">
            </a>
        </div>
        <div class="self-center">
            ...
            lg:fixed lg:top-0 lg:left-0 lg:w-full lg:h-min-screen lg:hidden">
                ...
                lg:bg-white lg:min-h-screen lg:self-start lg:flex-col lg:w-[274px] lg:shadow-custom-4 lg:rounded-tr-[50px] ">
                    ...
                    <ul
                        class="flex uppercase font-inter-semibold text-grey text-xs self-center text-raisin-black
