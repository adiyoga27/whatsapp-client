<section class="text-arsenic w-full text-center pt-36 font-poppins-regular
lg:pt-32" id="product">
    <div class="lg:px-8">
        <div class="text-base font-poppins-semibold  mb-6 relative text-laurel-green
    lg:text-[13px]  lg:mb-3">
            Dibuat Untuk Anda</div>
        <div class="text-[40px] font-poppins-bold text-apple  mb-6
    lg:text-[24] lg:mb-4">Produk Varash</div>
        <div class="text-sm text-gray-3
    lg:text-[13px]">Berikut daftar dari produk varash yang kami buat untuk Anda.
        </div>
    </div>
                        ...
                        <div class="bg-white border border-chinese-white h-100.5 flex flex-col justify-between">
                            ...
                            <div class=" text-center text-[15px] px-9 pb-7">
                                ...
                                lg:text-[13px] lg:mb-4">
                                    {{-- Lorem ipsum dolor sit amet consectetur adipiscing elit magna aligua --}}
