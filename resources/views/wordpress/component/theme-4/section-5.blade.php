<section class="flex justify-between w-full max-w-[1107px] mx-auto py-38.5
lg:flex-col lg:px-8 lg:py-20" id="testimonial">
    <div class="w-92.25
    lg:text-center lg:w-auto lg:mx-auto">
        <div class="font-poppins-semibold text-base mb-4.25 text-laurel-green
         lg:text-[13px]">
            Testimonial</div>
        <div class="font-inter-bold text-[40px] leading-[52px] mb-1
       lg:text-[24px] ">Testimonial
            <span class="text-apple">Produk Varash</span>
        </div>
        <div class="font-poppins-regular text-spanish-gray pb-11.25
        lg:text-[13px]">Berikut daftar dari produk
            varash yang kami buat
            untuk Anda.
        </div>
        <a href="/testimonial">
            <button
                class="font-poppins-semibold text-sm text-white  h-12 w-42.5 rounded-[5px] shadow-custom-1 bg-apple lg:hidden">
                Lihat Semua
            </button>
        </a>
    </div>
            ...
            <div
                ...
                <div class="self-center">
                    <img src="{{ asset('storage/' . $testimonial[$i]->photo) }}" alt="avatar"
                        class="w-26 h-26
                            lg:w-[63px] lg:h-[63px] object cover rounded-full">
                </div>
            </div>
        @endfor
    </div>
    <div class="mt-20">
        <a href="/testimonial">
            <button
                class="font-poppins-semibold text-sm text-white  h-12 w-42.5 rounded-[5px] shadow-custom-1 bg-apple hidden
