<section class="text-arsenic w-full text-center pt-0 pb-20 font-poppins-regular 
 lg:pt-10">
    <div class="lg:px-8">
     ...
     lg:text-[24] lg:mb-4  lg:text-left">Produk Varash
        </div>
        <div class="font-inter-regular text-sm text-spanish-gray
     lg:text-[13px]  lg:text-left">Berikut daftar dari
            produk
            varash yang
            kami buat untuk
            Anda.</div>
