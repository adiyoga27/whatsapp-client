...
lg:flex-col-reverse lg:px-8 lg:gap-y-10">
    <div>
        <img class="w-[291px] h-[407px] object-contain lg:mx-auto lg:w-[139.69px] lg:h-[195.72px]"
            class="w-full h-full object-contain" src="{{ asset('storage/' . $profile->tagline_img) }}" alt="img-minyak">
    </div>
