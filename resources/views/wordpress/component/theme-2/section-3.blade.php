<section
    class="font-inter-regular w-full max-w-[1107px] mx-auto flex justify-between pt-25.75 relative
...
lg:flex-col lg:px-8 lg:before:hidden lg:pt-6">
    <div class="w-full max-w-[355.29px] self-center
    lg:mb-10 lg:text-center">
        <div
        ...
        lg:after:-translate-x-1/2 lg:after:left-1/2 lg:mb-4 ">
