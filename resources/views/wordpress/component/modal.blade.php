<div
    class="modal animated faster modal-up fadeOut hidden overflow-y-auto  fixed w-full h-full bg-grey-cover  top-0 left-0 items-center justify-center flex z-50">
    <div class="relative w-auto h-auto my-auto">
        <div
            class="modal-content my-10 w-full max-w-[1041px]   mx-auto rounded-md z-50  flex relative  
        md:my-0 md:w-[100vw]">
            <div>
                <div class="flex flex-col my-10 mx-2 px-6 rounded-[8px] bg-white lg:px-4 ">
                    <div class="flex flex-row-reverse justify-between ">
                        <div class="w-[36px] h-[36px] block bg-apple rounded-full flex justify-center items-center relative self-center cursor-pointer
                        "
                            id="modal-hidden">
                            <svg class="lg:w-[8px]" class="absolute left-1/2 -translate-x-1/2" width="10"
                        ...
                        <div class="my-5
                        ">
                            <svg class="lg:w-[28px]" width="36" height="29" viewBox="0 0 36 29" fill="none"
                   ...
                   lg:mb-4">
                       ...
                       lg:w-24 lg:h-24">
                            <img src="" alt="avatar"
                                class="w-full h-full object cover rounded-full border-[3px] border-apple rounded-full">
                        </div>
                    </div>
                    <div
                        class="font-kanit-semibold text-[24px] text-apple self-center  text-center mb-6 title
                    lg:text-[16px] lg:mb-2">
                        Tidak Ada</div>
                    <div class="font-poppins-regular text-[14px] self-center des
                    lg:text-[12px]">
                        Tidak ada
                    </div>
