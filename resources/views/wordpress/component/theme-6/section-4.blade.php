<section class="text-arsenic w-full text-center pt-16 pb-20 font-poppins-regular
lg:px-3 lg:pt-10">
    ...
    lg:text-[13px]">Berikut daftar dari produk varash yang
        kami buat untuk
        Anda.</div>
                    ...
                    <div
                        ...
                        <div class="bg-white border border-chinese-white h-100.5 flex flex-col justify-between">
                            ...
                            <div class=" text-center text-[15px] px-9 pb-7">
                                ...
                                <div class="text-apple  lg:text-[13px]"><a href="/product">Lihat Selengkapnya</a></div>
                            </div>
                        </div>
                    </div>
                @endfor
    ...
    <div>
        <a href="/product">
            <button
                ...
                lg:mx-auto lg:text-[13px] lg:h-10">
                Lihat Semua</button>
        </a>
    </div>
</section>
