<section class=" py-24 custom-section-5 theme-6
lg:px-8">
    <div class="w-full max-w-[1107px] mx-auto">
        ...
        lg:flex-col lg:mt-10 lg:gap-y-10">
            @for ($i = 0; $i < (count($testimonial) > 3 ? 3 : count($testimonial)); $i++)
                <div
                    class="w-full max-w-[342px] shadow-custom-3 rounded-[5px] py-7 px-4 relative text-center testimoni-modal cursor-pointer
                lg:self-center">
                    <div>
                        <div class="my-5 text-center">
                            <svg class="mx-auto" width="36" height="29" viewBox="0 0 36 29" fill="none"
                        ...
                        <div class="font-poppins-regular text-gray-4 text-[13px] mb-3 h-25 line-clamp-5 h-[95px] des">
                            {!! strip_tags($testimonial[$i]->description) !!}
                        </div>
                    </div>
                    <div class="self-center">
                        ...
                        <div class="text-apple text-base font-kanit-semibold mt-3 title">{{ $testimonial[$i]->name }}
                        </div>
                    </div>
                </div>
            @endfor
