<section class="w-full mx-auto max-w-[1107px] pt-28">
    ...
    lg:self-center lg:max-w-full">
                <div>
                    ...
                    <div class="font-poppins-regular text-gray-1 text-[13px] mb-3 h-25 line-clamp-5 h-[95px] des">
                ...
                <div class="self-center">
                    ...
                    <div class="text-apple text-base font-kanit-semibold mt-3 title">{{ $testimonial[$i]->name }}</div>
                </div>
            </div>
        @endfor
    </div>
