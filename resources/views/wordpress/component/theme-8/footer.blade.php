<footer class="bg-green-lin-3 w-full py-16.75 font-poppins-regular">
    <div class=" w-full max-w-[1107px] grid grid-cols-5 mx-auto mb-16
    lg:grid-cols-1 lg:gap-10 lg:px-8">
        <div>
            <div class="mb-4">
        ...
        <div>
            <div class="font-poppins-medium text-[13px] text-white mb-3.25">MENU</div>
        ...
        <div>
            <div class="font-poppins-medium text-[13px] text-white mb-3.25">KONTAK</div>
    ...
    <div class=" w-full max-w-[1107px] border-t border-white mx-auto relative">
        <div class="flex gap-x-[20px] justify-center self-center mt-10
        lg:self-start  ">
