...
">
    ...
    <div class=" bg-nyanza py-[92px] lg:py-20 ">
        <div class="flex justify-center gap-x-[16px] mb-12 mt-14 
        ...
        <div class=" text-center">
            <a href="/testimonial">
                <button
                    class="font-poppins-semibold text-sm text-white  h-12 w-42.5 rounded-[5px] shadow-custom-1 bg-arsenic mx-auto 
