<footer class="bg-outer-space w-full py-16.75 font-poppins-regular">
    <div class=" w-full max-w-[1107px] flex justify-between mx-auto
    lg:flex-col lg:gap-10 lg:px-8">
        <div>
            <div class="mb-4">
                <img src="{{ asset('/wordpress/img/logo-2.png') }}" alt="">
            </div>
            <div>
                <div class="font-poppins-medium text-[13px] text-white mb-5">Contact Us</div>
                <div class="text-[13px] text-bright-gray mb-4 flex gap-x-4">
                    ...
                    <div ass="self-center">{{ $profile->phone_cs_1 }}</div>
                </div>
                <div class="text-[13px] text-bright-gray mb-4 flex gap-x-4">
                    <div class="self-center">
                        <svg width="19" height="19" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_652_579)">
                                <path
                ...
                <div class="text-[13px] text-bright-gray mb-4 flex gap-x-4">
                    ...
                    <div class="self-center max-w-[310px]"> {{ $profile->store_address }}</div>
                </div>
        ...
        <div class="self-end lg:self-center">
            <ul class="text-bright-gray flex  gap-x-[42px] text-[13px]">
                <li><a href="/">Home</a></li>
    ...
    <div class=" w-full max-w-[1107px] border-t border-white mx-auto relative">
        <div class="flex gap-x-[20px] self-center justify-center pt-8
        lg:self-start lg:justify-start lg:px-8">
            ...
            <a href="https://www.twitter.com/{{ $sosmed->twitter }}" target="_blank">
                <svg width="42" height="42" viewBox="0 0 42 42" fill="none"
                    ...
                    <path
                        ...
                        fill="white" />
                    <rect x="0.5" y="0.5" width="41" height="41" rx="19.5"
                        stroke="white" />
                </svg>
            </a>
        ...
        <div
            class="absolute top-1/2 -translate-y-1/2 right-0 text-cultured font-inter-regular text-[12px]
        lg:relative lg:pt-10 lg:top-0 lg:bottom-0 lg:px-8 lg:-translate-y-1">
            ©
            2022, {{ $profile->web_name }}</div>
    </div>
</footer>
