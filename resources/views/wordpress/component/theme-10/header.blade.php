                    ...
                    lg:flex-col lg:self-start lg:w-full lg:text-[17px] lg:uppercase lg:mb-3 lg:mt-6">
                        <a href="/"
                            class="my-2 mx-3.5 relative  cursor-pointer after:content-[''] {{ Request::is('/')
                                ? 'after:absolute after:-bottom-4 after:left-1/2 after:-translate-x-1/2 after:bg-apple after:h-1 after:w-2/3 after:rounded-[3px]
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        lg:after:left-0 lg:after:top-0 lg:after:h-full lg:after:w-1 lg:after:rounded-r-[3px] lg:my-0 lg:py-4 lg:px-10'
                                : '' }}
                             hover:after:absolute hover:after:-bottom-4 hover:after:left-1/2 hover:after:-translate-x-1/2 hover:after:bg-apple hover:after:h-1 hover:after:w-2/3 hover:after:rounded-[3px]
