<section class=" py-24 custom-section-5 theme-5
lg:px-8 lg:py-10">
    <div class="w-full max-w-[1107px] mx-auto">
        ...
        lg:text-[24px]">
            Testimonial
            <div class="text-apple lg:-mt-3">Produk Varash</div>
        </div>
        ...
        lg:flex-col lg:gap-y-20">
            @for ($i = 0; $i < (count($testimonial) > 3 ? 3 : count($testimonial)); $i++)
                ...
                lg:self-center lg:mx-auto">
                    <div class="absolute -top-12 left-1/2 -translate-x-1/2">
                        <div class="">
                            <img src="{{ asset('storage/' . $testimonial[$i]->photo) }}" alt="avatar"
                                class="w-26 h-26 object cover rounded-full">
                        </div>
                    </div>
                    <div>
                        <div class="my-5">
                        ...
                        <div class="text-apple text-base font-kanit-semibold mb-3 title">{{ $testimonial[$i]->name }}
                        </div>
                    ...
                    {{-- <div class="self-center">
                        <div class="w-26 h-26">
                            <img src="{{ asset('/wordpress/img/avatar.jpeg') }}" alt="avatar"
