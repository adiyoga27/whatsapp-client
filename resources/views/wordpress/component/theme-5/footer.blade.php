<footer class="bg-outer-space w-full pt-16.75 font-inter-regular">
    ...
    lg:grid-cols-1 lg:gap-y-10 lg:px-8">
        <div>
            ...
            <div class="text-[13px] text-bright-gray w-49 mt-5">
    ...
    <div
        class="w-full max-w-[1107px] mx-auto flex justify-center gap-x-7.5 relative mt-16 pt-9
    before:content-[''] before:w-full before:h-px before:absolute before:bg-white before:top-0 before:left-0
    lg:justify-start lg:px-10 lg:py-10">
        <div>
            <a href="https://www.instagram.com/{{ $sosmed->instagram }}" target="_blank">
                <svg width="42" height="42" viewBox="0 0 42 42" fill="none"
                    ...
                    <path
                        ...
                        fill="white" />
                    <path
                        d="M26.3393 16.8617C27.0027 16.8617 27.5404 16.3239 27.5404 15.6606C27.5404 14.9972 27.0027 14.4595 26.3393 14.4595C25.6759 14.4595 25.1382 14.9972 25.1382 15.6606C25.1382 16.3239 25.6759 16.8617 26.3393 16.8617Z"
                        fill="white" />
