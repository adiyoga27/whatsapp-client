                    ...
                    lg:flex-col lg:self-start lg:w-full lg:text-[17px] lg:uppercase lg:mb-3 lg:mt-6">
                        <a href="/"
                            class="my-2 mx-3.5 relative  cursor-pointer after:content-[''] {{ Request::is('/')
                                ? 'after:absolute after:-bottom-4 after:right-0 after:bg-apple after:h-1 after:w-2/3 after:rounded-[3px]
                                                                                                                                                                                                    lg:after:left-0 lg:after:top-0 lg:after:h-full lg:after:w-1 lg:after:rounded-r-[3px] lg:my-0 lg:py-4 lg:px-10'
                                : '' }}
                             hover:after:absolute hover:after:-bottom-4 hover:after:right-0 hover:after:bg-apple hover:after:h-1 hover:after:w-2/3 hover:after:rounded-[3px]
                        ...
                        <a href="/article"
                            class="my-2 mx-3.5 relative  cursor-pointer after:content-['']  {{ Request::is('article/*') || Request::is('article')
                                ...
                                : '' }}
                            hover:after:absolute hover:after:-bottom-4 hover:after:right-0 hover:after:bg-apple hover:after:h-1 hover:after:w-2/3 hover:after:rounded-[3px] 
                            lg:hover:after:left-0 lg:hover:after:top-0 lg:hover:after:h-full lg:hover:hover:after:w-1  lg:my-0 lg:py-4 lg:px-10  lg:mx-0 ">
                            artikel</a>
                        <a href="/testimonial"
